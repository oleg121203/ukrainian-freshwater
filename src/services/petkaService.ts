...
export async function generateQuizQuestions(ingrs: string[] = []): Promise<PetkaQuestion[]> {
  ...
  const prompt = `Ти — Петька, кмітлива креветка-кухар. Згенеруй 5 ЛЕГКИХ і дружніх кулінарних запитань українською з варіантами відповідей (3 варіанти) і познач правильний індекс. Уникай «хардкорних» чи надто вузьких тем — роби питання інтуїтивними, побутовими. Теми: приготування морепродуктів, безпека харчування, базові смакові поєднання. Якщо задано інгредієнти користувача, додай 1–2 питання саме про них: ${ingrs.join(', ')}. Поверни тільки валідний JSON масив у форматі:
  [
