...
import { ChefHat, Users, Star, ArrowLeft, Handshake, Trophy, Certificate } from '@phosphor-icons/react'
  ...
  const clientTestimonials = [
    {
      ...
      testimonial_uk: 'AquaFarm стали нашим надійним партнером. Якість креветок завжди на найвищому рівні, а доставка - точна до хвилини.',
      testimonial_en: 'AquaFarm has become our reliable partner. The quality of prawns is always at the highest level, and delivery is accurate to the minute.',
      rating: 5,
    ...
    },
    {
      ...
      testimonial_uk: 'Співпрацюємо вже 3 роки. Особливо цінуємо можливість замовляти великі партії зі стабільною якістю.',
      testimonial_en: 'We have been cooperating for 3 years. We especially value the ability to order large batches with stable quality.',
      rating: 5,
    ...
    },
    {
      ...
      testimonial_uk: 'Найкращі креветки на ринку! Клієнти завжди в захваті від страв з продукції AquaFarm.',
      testimonial_en: 'The best prawns on the market! Clients are always delighted with dishes made from AquaFarm products.',
      rating: 5,
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {professionalPrograms.map((program, index) => (
              <Card key={index} className="hover:shadow-lg transition-shadow duration-300 border-t-4 border-t-purple-500">
                <CardHeader>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {supportServices.map((service, index) => (
              <div key={index} className="flex items-start gap-4 p-6 bg-white rounded-lg border border-purple-200">
